...
const SmartCafeTechDetail = () => {
  ...
  const startupData = {
    ...
    team: [
      {
        name: "Sarah Chen",
        role: "CEO & Founder",
        experience: "18+ years in tech & hospitality",
        education: "MBA Stanford, BSc Computer Science MIT",
        photo: "👩‍💼"
      },
      {
        name: "Rizki Pratama",
    ...
    market: {
      size: "4.2B USD",
      growth: "18.3% annually",
      competition: "High",
      barriers: "Medium",
      opportunities: "SaaS licensing, international expansion, enterprise solutions"
    },
    ...
    growthPlans: [
      ...
      "Develop AI-powered menu optimization",
      "Partnership with major coffee chains",
    ...
    investmentTerms: {
      ...
      exitStrategy: "IPO or strategic acquisition in 6-8 years",
      votingRights: "Yes",
        ...
        <div className="text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <div className="text-center p-3 border border-black">
              <div className="text-lg font-bold text-blue-600">{startupData.founded}</div>
            ...
            <div className="text-center p-3 border border-black">
              <div className="text-lg font-bold text-purple-600">{startupData.stage}</div>
      ...
      <div className="border-2 border-black p-6 bg-blue-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              <span className="text-blue-600 mr-2">✅</span>
              <span>Strong market position</span>
            </div>
            <div className="flex items-center">
              <span className="text-blue-600 mr-2">✅</span>
          ...
          <div className="space-y-2">
            <div className="flex items-center">
              <span className="text-blue-600 mr-2">✅</span>
              <span>Experienced tech team</span>
            </div>
            <div className="flex items-center">
              <span className="text-blue-600 mr-2">✅</span>
  ...
  return (
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      {/* Startup Header */}
      <div className="border-b-2 border-black bg-blue-50 p-6">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white border-4 border-black p-6 max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold">💰 INVEST IN SMARTCAFE TECH</h3>
              <button 
...
export default SmartCafeTechDetail;
