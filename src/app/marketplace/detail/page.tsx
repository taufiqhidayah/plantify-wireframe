      ...
      <header className="border-b-2 border-black p-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-4">
            <div 
              className="border border-black px-3 py-1 cursor-pointer hover:bg-gray-100"
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 border-t border-black pt-4 space-y-2">
            <div 
              className="border border-black px-3 py-2 text-center cursor-pointer hover:bg-gray-100"
              onClick={() => router.push("/marketplace")}
            >
              Browse Startups
            </div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="border-4 border-black p-6 md:p-8 mb-8">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              ...
              <button 
                className="border-2 border-black px-6 py-3 text-lg hover:bg-gray-100"
                onClick={() => router.push("/onboarding")}
              >
                Register as Founder
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <div className="text-sm">
                    NFT Price: <span className="font-bold">$75 ckUSDC</span>
                  </div>
                  <div className="text-sm">
                    Monthly Returns:{" "}
                    <span className="font-bold">$12 ckUSDC</span>
                  </div>
                </div>
                <div className="mb-4">
                ...
                <button 
                  className="border-2 border-black text-center py-2 w-full cursor-pointer hover:bg-black hover:text-white"
                  onClick={() => router.push("/marketplace/startup/1")}
                >
                  VIEW DETAILS
                </button>
              </div>
            ...
            <div className="border-2 border-black bg-white">
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <div className="text-sm">
                    NFT Price: <span className="font-bold">$100 ckUSDC</span>
                  </div>
                  <div className="text-sm">
                    Monthly Returns:{" "}
                    <span className="font-bold">$18 ckUSDC</span>
                  </div>
                </div>
                <div className="mb-4">
                  <div className="text-sm mb-1">Funding Progress:</div>
                ...
                <button 
                  className="border-2 border-black text-center py-2 w-full cursor-pointer hover:bg-black hover:text-white"
                  onClick={() => router.push("/marketplace/startup/2")}
                >
                  VIEW DETAILS
                </button>
              </div>
            ...
            <div className="border-2 border-black bg-white">
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <div className="text-sm">
                    NFT Price: <span className="font-bold">$50 ckUSDC</span>
                  </div>
                  <div className="text-sm">
                    Monthly Returns:{" "}
                    <span className="font-bold">$8.5 ckUSDC</span>
                  </div>
                </div>
                <div className="mb-4">
                  <div className="text-sm mb-1">Funding Progress:</div>
                ...
                <button 
                  className="border-2 border-black text-center py-2 w-full cursor-pointer hover:bg-black hover:text-white"
                  onClick={() => router.push("/marketplace/startup/3")}
                >
                  VIEW DETAILS
                </button>
              </div>
      ...
      <section className="py-16 md:py-20 px-4 bg-black text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <button 
              className="border-2 border-white px-8 py-4 text-lg hover:border-gray-300 hover:text-gray-300"
              onClick={() => router.push("/onboarding")}
            >
              REGISTER STARTUP
            </button>
